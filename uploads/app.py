...
# --- Configuration ---
TOKEN = '8437718075:AAE3B7asQCOVUAqver9WRYjxQ40Qfx2CUHI' # Replace with your actual token
OWNER_ID = 7643067854 # Replace with your Owner ID
ADMIN_ID = 7643067854 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@MUNNA_TCP' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/MunnaTcpBio' # Replace with your update channel link
...
# File upload limits
FREE_USER_LIMIT = 1
SUBSCRIBED_USER_LIMIT = 9999 # Changed from 10 to 15
ADMIN_LIMIT = 9      # Changed from 50 to 999
